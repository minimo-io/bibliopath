  ...
  <div class="align-items-center mb-4 mt-5">
    ...
    <div class="welcome-box col-lg-12 text-center text-lg-left order-lg-1 px-0">
      ...
      <b-card no-body class="p-0 pt-0 mt-0" style="border:0;">
        ...
        <center>
          <h2 class="hero-h1 mt-0 mb-4 mb-md-5 bd-text-purple-bright display-4">
            The Open Editorial
          </h2>
          ...
          <div class="row">
              <div class="col-md-4 mb-3 welcome-image-box Xtext-right">
                    ...
                    <b-img src="https://minimo.io/assets/imgs/bibliopath.png" fluid alt="bienvenido-a-hopmasters" class="mt-0 mb-0 animated flip"></b-img>
              ...
              <div class="col-md-7 mt-2">
                  ...
                  <div class="container px-0 mt-4 mb-0 text-left">
                    <b-button size="md" variant="outline-danger" class="btn-sm-block mr-3">
                      ...
                      <b-badge pill variant="danger">283</b-badge>
                    </b-button>
